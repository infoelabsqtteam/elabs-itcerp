...
class CreateOrderProcessLogTable extends Migration
{
    ...
    public function up()
    {
	    ...
	    $table->integer('opl_user_id')->unsigned()->index()->nullable();
	    ...
	    $table->tinyInteger('opl_amend_status')->unsigned()->index()->nullable();
	    $table->tinyInteger('opl_amend_by')->unsigned()->index()->nullable();
	    $table->text('note')->nullable();
	    $table->text('error_parameter_ids')->nullable();
	    $table->timestamps();
