...
class CreateOrderMailDtlTable extends Migration
{
    ...
    public function up()
    {
	    ...
	    $table->tinyInteger('mail_content_type')->comment('1-New Party Sample booked,2-order placed,3-Report Generation,4-invoice Generation,5-Stability Prototype Order');
	    ...
	    $table->tinyInteger('mail_type')->comment('1 for final,2 for Draft');
	    $table->Integer('mail_by')->nullable();
	    $table->tinyInteger('mail_status');
	    $table->tinyInteger('mail_active_type')->comment('Latest Mail Send');    	
