<tr>
	...
	<td>
		<div class="form-group">
			<input type="text" 
				class="bgWhite form-control descrip" 
				readonly
	...
	<td>
		<div ng-hide="!$index" class="form-group">
			<a href="javascript:;" title="Remove" class="btn btn-danger" ng-click="deletePORow($index);"><i class="glyphicon glyphicon-minus"></i>Remove</a>
		</div>&nbsp;
	</td>
</tr>