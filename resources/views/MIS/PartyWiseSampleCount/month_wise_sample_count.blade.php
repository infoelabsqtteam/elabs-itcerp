<div class="row" ng-if="MISReportDivName == 'PWSCMW003'">       
    
    <div class="col-xs-12 report-header">
        <div class="pull-left"><strong id="form_title">Party Wise Sample Count Report : Month Wise<span ng-if="MISReportData.tableBody.length">([[MISReportData.tableBody.length]])</span></strong></div>
    </div>
