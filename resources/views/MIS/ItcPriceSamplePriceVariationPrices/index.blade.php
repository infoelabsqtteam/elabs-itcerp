<div class="row" ng-if="MISReportDivName == 'ITCVSSM21'">

    <div class="col-xs-12 report-header" ng-if="MISReportData.heading">
        <div class="pull-left"><strong id="form_title" ng-bind="MISReportData.heading">Loading...</strong></div>
    </div>
            ...
            <div id="no-more-tables" class="row col-xs-12">
                <table class="col-sm-12 table-striped table-condensed cf">
                    ...
                    <tbody>
                        ...
                        <tr ng-if="!MISReportData.tableBody.length">
