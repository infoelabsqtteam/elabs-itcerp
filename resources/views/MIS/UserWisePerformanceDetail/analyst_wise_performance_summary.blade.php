<div class="row" ng-if="MISReportDivName == 'AWPS013'">       
    
    <div class="col-xs-12 report-header">     
        <div class="col-xs-6 col-sm-6 text-left"><strong id="form_title">Analyst Wise Performance Summary Report<span ng-if="MISReportData.tableBody.length">([[MISReportData.tableBody.length]])</span></strong></div>
                ...
                <table class="col-sm-12 table-striped table-condensed cf">
                    ...
                    <tbody>
                        <tr dir-paginate="MISReportTdData in MISReportData.tableBody | filter:filterOrders | itemsPerPage: 300 | orderBy:predicate:reverse">
                            <td ng-repeat="(key, value) in MISReportTdData" data-title="[[key]]" class="ng-binding">[[value]]</td>
                        </tr>                        
