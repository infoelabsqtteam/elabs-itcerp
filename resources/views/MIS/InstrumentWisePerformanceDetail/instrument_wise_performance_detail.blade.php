<div class="row" ng-if="MISReportDivName == 'IWPD012'">
    
    <div class="col-xs-12 report-header">
        <div class="pull-left"><strong id="form_title">Instrument Wise Performance Detail<span ng-if="MISReportData.tableBody.length">([[MISReportData.tableBody.length]])</span></strong></div>
    </div>
