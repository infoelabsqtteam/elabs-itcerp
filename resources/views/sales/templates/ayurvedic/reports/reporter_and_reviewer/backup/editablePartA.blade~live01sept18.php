<div class="col-md-12" id="editablePartA" ng-if="viewEditPartAForm">
		  ...
		  <table class="table table-bordered" style="margin:0;">
				 <tbody>
				  <tr>
					  <td colspan="2"><span class="bold font_lable editableSampleName">Sample Name</span><span class="bold">:</span>
				 ...
				 <tr>
					 ...
					 <tr>
								<td class=" bodr_top bodr_bottom width50"><span class="bold font_lable">Submitted By</span><span class="bold">:</span>
										  <span ng-if="viewOrderReport.customer_name">[[viewOrderReport.customer_name]]</span>
				 ...
				 <tr>
						  <td class=" bodr_top width50"><span class="bold font_lable">Mfg. Lic. No.</span><span class="bold">:</span>
