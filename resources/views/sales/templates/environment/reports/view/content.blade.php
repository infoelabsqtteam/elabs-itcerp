<form name="orderReportForm" id="orderReportForm" novalidate>	
	...
	<div ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER || defined('IS_CRM') && IS_CRM}}" class="container-fluid pdng-20 botm-table" id="foorPartA">
		<div class="col-md-12 col-xs-12 botm-row dis_flex" style="padding:0">
			...
			<div class="col-md-6 col-xs-6 bord">
				...
				<div class="col-sm-6  col-xs-7 upr-case"><span>:</span> 
					...
					<span ng-if="!viewOrderReport.with_amendment_no"></span> </div></div>
			</div>
		</div>
		...
		<div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
			...
			<div class="col-md-5 col-xs-5 bord">Batch Size/Location</div>
			<div class="col-md-6 col-xs-5 bord">
		...
		<div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
			...
			<div class="col-md-5 col-xs-5 bord">Seal (Intact/Not Intact/Unsealed)</div>
			<div class="col-md-6 col-xs-5 bord">
				...
				<span ng-if="viewOrderReport.is_sealed==3">NA</span>
				<span ng-if="viewOrderReport.is_sealed==4">Sealed by Officer Incharge</span>
				<span ng-if="viewOrderReport.is_sealed==5">Sealed by Department</span>
			</div>
		</div>
		<div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
			...
			<div class="col-md-6 col-xs-5 bord">
				...
				<span ng-if="viewOrderReport.is_sealed==2">NA</span>
				<span ng-if="viewOrderReport.is_sealed==4">Signed by Officer Incharge</span>
				<span ng-if="viewOrderReport.is_sealed==5">Signed by Department</span>
			</div>
		</div>
		<div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
		...
		<div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
			...
			<div class="col-md-5 col-xs-5 bord">Test Request Submitted By</div>
			<div class="col-md-6 col-xs-5 bord">
		...
		<div class="col-md-12 col-xs-12 botm-row  bord" style="padding:0">
			...
			<div class="col-md-12 col-xs-12 mT30">
				<div class="col-sm-4 col-xs-4 text-center mrgn_20 mT30">
					<p ng-if="viewOrderReport.status >= 4 && viewOrderReport.report_microbiological_name && viewOrderReport.report_microbiological_sign" style="width:100%;">
						<img ng-if="viewOrderReport.report_microbiological_sign_path" height="40px" width="100px" style="margin:-40px 0 0;" ng-alt="[[viewOrderReport.report_microbiological_name]]" ng-src="[[viewOrderReport.report_microbiological_sign_path]]" />
					</p>
				...
				<div class="col-sm-4 col-xs-4 text-center mrgn_20 mT30">
					...
					<h5 ng-if="viewOrderReport.status >= 6"></h5>[[viewOrderReport.reviewing_date]]</h5>
				...
				<div class="col-sm-4 col-xs-4 text-right mrgn_20 mT30">
					...
					<h5 ng-if="viewOrderReport.status >= 7">[[viewOrderReport.finalizng_date]]</h5>
