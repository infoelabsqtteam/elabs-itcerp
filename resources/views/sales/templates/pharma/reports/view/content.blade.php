	...
	<div class="container pdng-20 botm-table" style="padding:10px;border: 1px solid;">
				...
				<tbody>
					<tr>
						<td colspan="2">
							...
							<span class="text-value" ng-if="viewOrderReport.sample_description">[[viewOrderReport.sample_description]]</span>
		...
		<div class="container-fluid pdng-20 botm-table" id="foorPartC">
			...
			<div ng-repeat="categoryParameters in orderParametersList">
				...
				<div ng-if = "categoryParameters.categoryName == viewOrderReport.testParametersWithSpace" class="col-md-12 col-xs-12 botm-row text-center dis_flex" style="padding:0">
					<div class="col-md-4 col-xs-4 bord upr-case">
		...
		<div ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER || defined('IS_CRM') && IS_CRM}}">
			...
			<div class="col-md-12 col-xs-12 mT30 mB20">
				...
				<div ng-if="viewOrderReport.status >= 4 && viewOrderReport.report_microbiological_name" class="col-sm-4 col-xs-4 text-center mrgn_20 mT30 mT30">
				...
				<div class="col-sm-4 col-xs-4 text-right mrgn_20 mT30">
					<span class="webStampView" ng-if ="viewOrderReport.status >= 7 && viewOrderReport.is_display_stamp && viewOrderReport.is_display_stamp=='1' && viewOrderReport.stampType"><img ng-src="{{SITE_URL.'/public/images/quality/'.GREEN_STANDARD_QUALITY}}"/></span>
					<span class="webStampView" ng-if ="viewOrderReport.status >= 7 && viewOrderReport.is_display_stamp && viewOrderReport.is_display_stamp=='1' && !viewOrderReport.stampType"><img  ng-src="{{SITE_URL.'/public/images/quality/'.RED_STANDARD_QUALITY}}"/></span>
					<span class="webStampView" ng-if ="viewOrderReport.status >= 7 && viewOrderReport.is_display_stamp && viewOrderReport.is_display_stamp=='2' && !viewOrderReport.stampType"><img  ng-src="{{SITE_URL.'/public/images/quality/'.NOT_STANDARD_QUALITY}}"/></span>
