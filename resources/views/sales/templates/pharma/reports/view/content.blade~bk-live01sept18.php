<form name="orderReportForm" novalidate>
	...
	<div class="container pdng-20 botm-table" style="padding:10px;border: 1px solid;">
		...
		<div ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER}}" class="col-md-12">
			<table class="table table-bordered" style="margin:0;">
				<tbody>
					...
					<tr>
						...
						<td class="bodr_top bodr_bottom width50">
					...
					<tr>
						<td colspan="2" style="padding:0!important">
							...
							<tr>
								<td colspan="2" class="bodr_top bodr_bottom width50">
									<span class="bold editableSampleName">Submitted By</span>
									<span class="bold">:</span>
		...
		<div class="col-md-12">
			<span class="pull-right bold">
				...
				<span> :</span>
				<span ng-if="viewOrderReport.is_amended_no">[[viewOrderReport.opl_date]]</span>
	   ...
	   <div ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER}}">
			<!-------------------------REPORT NOTE------------------------------->
			...
			<div class="col-md-12 col-xs-12 mT30">
				...
				<div class="col-sm-4 col-xs-4 text-center mrgn_20" alt="[[viewOrderReport.is_display_stamp]]">
