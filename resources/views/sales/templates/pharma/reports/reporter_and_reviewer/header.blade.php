<div class="row pdng-20">
	...
	<div class="row pdng-20" >
		<div class="col-sm-12 col-xs-12 flexCenter header-content mT10" ng-bind-html="viewOrderReport.header_content" ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER}}"></div>
