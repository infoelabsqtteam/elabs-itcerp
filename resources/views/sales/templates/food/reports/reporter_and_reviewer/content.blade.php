<form name="orderReportFormByReporter" id="orderReportFormByReporter" novalidate>
    ...
    <div class="container-fluid pdng-20 botm-table" id="foorPartA">
        <div class="col-md-12 col-xs-12 botm-row dis_flex" style="padding:0">
            <div class="col-md-6 col-xs-6 bord">
                <div class="col-sm-12 col-xs-12 report">
                    ...
                    <div class="col-sm-6 col-xs-6 upr-case" ng-if="viewEditTestStandard">Test Report as per IS : <em class="asteriskRed">*</em></div>
                    <div class="col-sm-6  col-xs-6" ng-if="viewEditTestStandard">
        ...
        <div id="nonEditablePartA" ng-if="viewNonEditablePartA">
            ...
            <div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
                ...
                <div class="col-md-6 col-xs-5 bord">
                    ...
                    <span ng-if="!viewOrderReport.remarks">N/A</span>
                </div>
            </div>
            <div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
            ...
            <div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
                ...
                <div class="col-md-6 col-xs-5 bord">
                    ...
                    <span ng-if="!viewOrderReport.sample_condition">N/A</span>
                </div>
            </div>
        </div>
        <!---nonEditablePartA------>
        ...
        <span ng-if="viewOrderReport.status == 5">
            <span ng-if="{{defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_ADMIN') && IS_ADMIN}}">
                @include('sales.templates.food.reports.reporter_and_reviewer.editablePartA')
            </span>
        </span>
        <!---editablePartA------>
    </div>
    ...
    <div class="container-fluid pdng-20 botm-table" id="foorPartD">
        <div class="col-md-12 col-xs-12 botm-row  bord" style="padding:0">
            ...
            <!--Name and Sinature-->
            <div class="col-md-12 col-xs-12 blank mT30 mB20"></div>
            <div class="col-md-12 col-xs-12 mT30 mB20">
                <div class="col-sm-4 col-xs-4 text-center mrgn_20">
                    <p ng-if="viewOrderReport.status >= 4 && orderTrackRecord.microbiological_detail" style="width:100%;"><img ng-if="orderTrackRecord.microbiological_detail.user_signature" height="40px" width="100px" style="margin:-40px 0 0;" ng-alt="[[orderTrackRecord.microbiological_detail.username]]" ng-src="[[orderTrackRecord.microbiological_detail.user_signature_file_url]]" /></p>
                    <h5 ng-if="viewOrderReport.status >= 4 && orderTrackRecord.microbiological_detail.user_signature && viewOrderReport.incharge_reviewing_date">[[viewOrderReport.incharge_reviewing_date]]</h5>
                    <p ng-if="viewOrderReport.status >= 4 && orderTrackRecord.microbiological_detail.username" style="font-size:10px;width:100%;">[[orderTrackRecord.microbiological_detail.username]]</p>
                    <h4 ng-if="viewOrderReport.status >= 4 && orderTrackRecord.microbiological_detail.user_signature_text">[[orderTrackRecord.microbiological_detail.user_signature_text]]</h4>
                </div>
                <div class="col-sm-4 col-xs-4 text-center mrgn_20">
                    <div ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewer_equipment_wise">
                        <p ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewer_equipment_wise.user_signature" style="width:100%;"><img height="40px" width="100px" style="margin:-40px 0 0;" ng-alt="[[orderTrackRecord.reviewer_equipment_wise.user_signature]]" ng-src="[[orderTrackRecord.reviewer_equipment_wise.user_signature_file_url]]" /></p>
                        <p ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewer_equipment_wise.username" style="font-size:10px;width:100%;">[[orderTrackRecord.reviewer_equipment_wise.username]]</p>
                        <h5 ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewer_equipment_wise.username && viewOrderReport.report_view_date">[[viewOrderReport.report_view_date]]</h5>
                        <h4 ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewer_equipment_wise.user_signature_text">[[orderTrackRecord.reviewer_equipment_wise.user_signature_text]]</h4>
                    </div>
                    <div ng-if="viewOrderReport.status >= 6 && !orderTrackRecord.reviewer_equipment_wise">
                        <p ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewing.username" style="width:100%;"><img height="40px" width="100px" style="margin:-40px 0 0;" ng-alt="[[orderTrackRecord.reviewing.user_signature]]" ng-src="{{SITE_URL.SIGN_PATH}}[[orderTrackRecord.reviewing.user_signature]]" /></p>
                        <p ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewing.username" style="font-size:10px;width:100%;">[[orderTrackRecord.reviewing.username]]</p>
                        <h5 ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewing.username">[[viewOrderReport.reviewing_date]]</h5>
                        <h4 ng-if="viewOrderReport.status >= 6 && orderTrackRecord.reviewing.username">Reviewer</h4>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-4 text-right mrgn_20 ">
                    <p ng-if="viewOrderReport.status >= 7 && orderTrackRecord.finalizing.user_signature" style="width:100%;"><img height="40px" width="100px" style="margin:-40px 0px 0px; padding-left: 15px;" ng-alt="[[orderTrackRecord.finalizing.user_signature]]" ng-src="[[orderTrackRecord.finalizing.user_signature_file_url]]" /></p>
                    <h5 ng-if="viewOrderReport.status >= 7 && viewOrderReport.finalizing_date">[[viewOrderReport.finalizing_date]]</h5>
                    <h4 ng-if="viewOrderReport.status >= 7 && orderTrackRecord.finalizing.username">[[orderTrackRecord.finalizing.username]]</h4>
                    <h4 ng-if="viewOrderReport.status >= 7 && orderTrackRecord.finalizing.user_signature_text">[Tech Manager (F&amp;C)]</h4>
                </div>
            </div>
            <!--/Name and Sinature-->

            <div class="col-md-12 col-xs-12 hideContentOnPdf mT30 mB20">
    ...
    <span ng-if="viewOrderReport.status == 4">
        <span ng-if="{{defined('IS_REPORTER') && IS_REPORTER || defined('IS_ADMIN') && IS_ADMIN}}">
            @include('sales.templates.food.reports.reporter_and_reviewer.needModificationByReporter')
        </span>
    </span>
    <span ng-if="viewOrderReport.status == 5">
        <span ng-if="{{defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_ADMIN') && IS_ADMIN}}">
            @include('sales.templates.food.reports.reporter_and_reviewer.needModificationByReviewer')
        </span>
    </span>
    <!--/Popup Div-->
</form>
