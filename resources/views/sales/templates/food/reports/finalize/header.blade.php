<div class="container-fluid pdng-20">
	...
	<div class="col-sm-12 col-xs-12 dis_flex hideContentOnPdf">	
		...
		<div class="col-sm-4 col-xs-4" ng-if="viewOrderReport.status==4">
			<h3 class="text-center">ADD TEST REPORT PART(B & D) - [[viewOrderReport.department_name | capitalizeAll]]</h3></span>
		</div>
		<div class="col-sm-4 col-xs-4" ng-if="viewOrderReport.status==5">
			<h3 class="text-center">REVIEW REPORT - [[viewOrderReport.department_name | capitalizeAll]]</h3>
		</div>
		<div class="col-sm-4 col-xs-4" ng-if="viewOrderReport.status==6">
			<h3 class="text-center">FINALIZE REPORT - [[viewOrderReport.department_name | capitalizeAll]]</h3>
		</div>
		<div class="col-sm-4 col-xs-4" ng-if="viewOrderReport.status==7">
			<h3 class="text-center">APPROVE REPORT - [[viewOrderReport.department_name | capitalizeAll]]</h3>
		</div>
		<div class="col-sm-4 col-xs-4" ng-if="viewOrderReport.status==8">
			<h3 class="text-center">APPROVED REPORT - [[viewOrderReport.department_name | capitalizeAll]]</h3>
		</div>
