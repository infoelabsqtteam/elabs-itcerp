<div id="editablePartA" ng-if="viewEditPartAForm">
    ...
    <div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
        ...
        <div class="col-md-6 col-xs-5 bord">
            <span ng-if="viewOrderReport.is_amended_no && viewOrderReport.orderAmendStatus">[[orderTrackRecord.reviewing.report_view_date ? orderTrackRecord.reviewing.report_view_date : orderTrackRecord.finalizing.report_view_date]]</span>
            <span ng-if="viewEditOrderReport.report_date && !viewOrderReport.is_amended_no" ng-bind="viewOrderReport.report_date"></span>
        </div>
    </div>
    <div class="col-md-12 col-xs-12 dis_flex botm-row" style="padding:0">
