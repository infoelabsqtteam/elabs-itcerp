<div class="container-fluid pdng-20">
	...
	<div class="col-sm-12 col-xs-12 dis_flex header-content mT10" ng-bind-html="viewOrderReport.header_content" ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER || defined('IS_CRM') && IS_CRM}}"></div>
	
	<div class="col-sm-12 col-xs-12 dis_flex" ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER || defined('IS_CRM') && IS_CRM}}">
		<div class="col-sm-4 col-xs-4"></div>
		<div class="col-sm-4 col-xs-4"><h3 class="text-center">TEST REPORT - [[viewOrderReport.department_name | capitalizeAll]]</h3></div>
		<div class="col-sm-4 col-xs-4"><span class="text-right"><h2 class="selectCatPlus text-right">Document QF : 2501</h2></span><br><span class="pagenum"></span></div>
	</div>
	
	<div  class="col-sm-12 col-xs-12 mB30" style="border:1px solid" ng-if="{{defined('IS_ADMIN') && IS_ADMIN || defined('IS_REPORTER') && IS_REPORTER || defined('IS_REVIEWER') && IS_REVIEWER || defined('IS_FINALIZER') && IS_FINALIZER || defined('IS_APPROVAL') && IS_APPROVAL || defined('IS_INVOICE_GENERATOR') && IS_INVOICE_GENERATOR || defined('IS_DISPATCHER') && IS_DISPATCHER || defined('IS_CRM') && IS_CRM}}">
		...
		<div class="col-sm-6 col-xs-6 bord-left" style="">
			<!--<div class="col-sm-12 col-xs-12 report"><div class="col-sm-4 col-xs-6">Sample Reg. No.</div><div class="col-sm-8 col-xs-6"><span>:</span> <span ng-bind="viewOrderReport.order_no"></span><span ng-if="viewOrderReport.is_amended_no">-[[viewOrderReport.is_amended_no]]</span></div></div>-->
