<div class="row" ng-hide="IsViewAlternativeHidden" id="erp_view_alternative_form_div">
    <!-- Modal -->
    <div id="viewEditAlternativeModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">        
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close modalClose" data-dismiss="modal">&times;</button>
					<!--<input type="text"  placeholder="Search" ng-model="search" class="form-control modalSearch">-->
                ...
                <div class="modal-body">                   
					...
					<span>[[alterTestProductStandardParamentersObj.time_taken_mins ? alterTestProductStandardParamentersObj.time_taken_mins+' Mins' : '']]</span>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" ng-click="selectAlternativeTestParameterRow([[alterTestProductStandardParamentersObj.product_test_param_altern_method_id]],[[alterTestProductStandardParamentersObj.product_test_dtl_id]])">Select</button>
                                    </td>
                                </tr>
                                <tr ng-show="!alterTestProductStandardParamenters.length">
                                    <td>No alternative found.</td>
                                </tr>
                            </tbody>
                        </table>      
                    </div>
