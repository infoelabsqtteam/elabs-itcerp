        ...
        <tr>
            <td colspan="6">
                <table width="100%" style="padding: 0px !important;">
                    <tr>
                        <td width="20.3%" align="left"></td>
                        <td width="50.3%" align="center"><b style="padding: 5px;font-size: 16px; width: 200px;">TEST CONFIRMATION DOCUMENT</b></td>
		...
		@if(!empty($viewData['orderParameters']))
			...
			@if(!empty($orderParameterCategoryName['categoryParams']))
				...
				<tr>
					...
					<td align="left" class="testResult" align="left"></td>
				    @endif
				</tr>
			    @endforeach				    
			@endif
