         ...
         <td colspan="5">
            <table width="100%" style="padding: 0px !important;">
               <tr>
                  ...
                  <td width="43.3%" align="center"><span style="padding:5px;font-size: 16px; width: 150px;font-weight:bold;">TEST CONFIRMATION DOCUMENT<span style="padding:10px !important;border-bottom:2px dotted #000 !important;">{{!empty($viewData['order']['order_no']) ? $viewData['order']['order_no'] : ''}}</span></span></td>
                  <td width="23.3%" valign="top" align="right">
                     <b style="vertical-align: top;">ORIGINAL<br> </b>
            ...
            <tbody>
               ...
               <tr>
                  <td style="padding:0px;" width="100%" align="left">
                     <span class="spanContent" style="float:left;display: inline-block;vertical-align: middle;">Sample Name</span><b>:</b><span style="position:relative;left:10px;padding-left:11px !important;width: 40%;">{{!empty($viewData['order']['sample_description']) ? $viewData['order']['sample_description'] : ''}}</span>
                  </td>
               ...
               <tr>
                  <td style="padding:0px;" width="100%" align="left">
                     <span class="spanContent" style="display: inline-block;vertical-align: middle;width: 100px;">Sample Quantity</span><b>:</b><span style="padding-left:11px !important;">{{!empty($viewData['order']['sample_qty']) ? $viewData['order']['sample_qty'] : ''}}</span></td>
                  <td width="100%" align="left" >
