...
<body>
	...
	<div class="page-break-auto">
	    ...
	    <table width="100%" class="pdftable" border="1" style="border-collapse:collapse;">
		...
		<tr>
		    <td align="center" width="5%" style="border-left: 1px solid!important;border-right: 1px solid #fff!important;padding-top:8px!important;padding-bottom:8px!important;">a.</td>
		...
		<tr>
		    <td align="center" width="5%" style="border-right: 1px solid #fff!important;border-left: 1px solid!important;padding-top:8px!important;padding-bottom:8px!important;">b.</td>
		...
		<tr>
		    <td align="center" width="5%" style="border-right: 1px solid #fff!important;border-bottom: 1px solid!important;border-left: 1px solid!important;padding-top:8px!important;padding-bottom:8px!important;">c.</td>
		...
		<tr>
		    <td align="center" colspan="3" style="border: 1px solid #fff!important;"></td>
		</tr>
	    </table>
	
	    <?php $colspanCounter = empty($notContainEquipment) ? 6 : 5 ;?>
	
	    <table width="100%" class="pdftable" border="1" style="border-collapse:collapse;font-size:13px!important;">
		...
		<tr>
			...
			{{!empty($viewData['order']['header_note']) ? $viewData['order']['header_note'] : '' }}
		    </td>
		</tr>
