...
<body>
	...
	<div class="page-break-auto">
		...
		<tr>
		    ...
		    <td align="left" width="20%" style="border-bottom: 1px solid!important;border-right: 1px solid!important;">&nbsp;:&nbsp;</td>
		</tr>
	    </table>	    
		...
		<tr>
		    ...
		    <th align="center" class="equipmentName">Inst. Used</th>
		    <th align="center" class="methodName">Method</th>
		    <th align="center" class="requirementName">Requirement</th>
		...
		@if(!empty($viewData['orderParameters']))
			...
			@if(!empty($orderParameterCategoryName['categoryParams']))
				...
				<tr>
					...
					<td class="parameter" align="left"><?php
					...
					<td align="left" class="testResult"></td>
				    @endif
				</tr>
			    @endforeach				    
			@endif
