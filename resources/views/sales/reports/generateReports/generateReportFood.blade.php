<html>
    ...
    @else
    @page { margin: 315px 20px 220px 20px;font-size:13px;}
	#header {left: 0;position: fixed;right: 0;text-align: center;top: -320px;width: 100%;height:auto;}
    @endif
    ...
    .right-content img{width:100px!important;}
        ...
        <tr>
            <td width="50%">
                ...
                <p style="margin: -25px 5px 30px 5px;font-size: 13px">
                    {{!empty($viewData['order']['customer_name']) ? $viewData['order']['customer_name'] : 'N/A'}}
                    <br />{{!empty($viewData['order']['customer_address']) ? $viewData['order']['customer_address'] : 'N/A'}}
                    <br />{{!empty($viewData['order']['city_name']) ? $viewData['order']['city_name'] : 'N/A'}}
                </p>
            </td>
            <td width="50%">
        ...
        <table width="100%" style="border-collapse:collapse;border-bottom:1px solid;">
            <tr>
                <td width="33.3%" align="left" valign="bottom">
                    @if(!empty($viewData['orderTrackRecord']['microbiological_detail']['user_signature']))
                        <p style="font-size:10px;padding-top:-5px!important;">
                            <span style="float:right;width:100%;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img style="width:70px;height:30px;padding-bottom:-6px!important;" alt="{{$viewData['orderTrackRecord']['microbiological_detail']['username']}}" src="{{$viewData['orderTrackRecord']['microbiological_detail']['user_signature_file_url']}}" /></span>
                        </p>
                        ...
                        <p style="font-size:13px;padding-top:-1px!important;"><b>{{$viewData['orderTrackRecord']['microbiological_detail']['username']}}</b></p>
                        <p style="font-size:13px;padding-top:-1px!important;"><b>[{{$viewData['orderTrackRecord']['microbiological_detail']['user_signature_text']}}]</b></p>
                    @endif
                </td>
                <td width="33.3%" align="center" valign="bottom">
                    @if(!empty($viewData['orderTrackRecord']['reviewer_equipment_wise']['user_signature']))
                        <p style="font-size:10px;padding-top:-5px!important;">
                        <p style="font-size:10px;padding-top:-5px!important;">
                            @if(!empty($viewData['orderTrackRecord']['reviewer_equipment_wise']['user_signature']) && file_exists($viewData['orderTrackRecord']['reviewer_equipment_wise']['user_signature_file_path']))
                                <span style="display:inline-block;width:100%;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img style="width:70px;height:30px;padding-top:-5px!important;" alt="{{$viewData['orderTrackRecord']['reviewer_equipment_wise']['user_signature']}}" src="{{$viewData['orderTrackRecord']['reviewer_equipment_wise']['user_signature_file_path']}}" /></span></br>
                            @endif
                            {{!empty($viewData['orderTrackRecord']['reviewer_equipment_wise']['username']) ? $viewData['orderTrackRecord']['reviewer_equipment_wise']['username'] : ''}}
                        </p>
                        ...
                        <p style="font-size:13px;padding-top:-1px!important;"><b>[{{$viewData['orderTrackRecord']['reviewer_equipment_wise']['user_signature_text']}}]</b></p>
                    @else
                        <p style="font-size:10px;padding-top:-5px!important;">
    ...
    <div id="content">
        ...
        <div class="page-break-auto">
            ...
            <table class="pdftable" width="100%" border="1" style="border-collapse:collapse;">
                <tr>
                    <td align="left" width="50%" colspan="2" style="font-size:13px;padding-top:5px!important;padding-bottom:5px!important;"><b>Test Report as per IS </b><b>:</b>{{!empty($viewData['order']['test_std_name']) ? $viewData['order']['test_std_name'] : 'N/A'}}</td>
                    <td align="left" width="50%" style="font-size:13px;"><b style="display: inline-block;vertical-align: middle;">With Amendment No.(s) </b><b>:</b>{{!empty($viewData['order']['with_amendment_no']) ? $viewData['order']['with_amendment_no'] : 'N/A'}}</td>
                </tr>
                <tr>
            ...
            <table class="pdftable" width="100%" border="1" style="border-collapse:collapse;">
                <tr>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['sample_description']) ? $viewData['order']['sample_description'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                ...
                <tr>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['grade_type']) ? $viewData['order']['grade_type'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['brand_type']) ? $viewData['order']['brand_type'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td align="left">{{!empty($viewData['order']['declared_values']) ? $viewData['order']['declared_values'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left"><img height="18px" src="{{!empty($viewData['order']['barcode']) ? $viewData['order']['barcode'] : 'N/A'}}"></td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['batch_no']) ? $viewData['order']['batch_no'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['mfg_date']) ? $viewData['order']['mfg_date'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['expiry_date']) ? $viewData['order']['expiry_date'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['sample_qty']) ? $viewData['order']['sample_qty'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['batch_size']) ? $viewData['order']['batch_size'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['packing_mode']) ? $viewData['order']['packing_mode'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['order_date']) ? date('d-m-Y',strtotime($viewData['order']['order_date'])) : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['analysis_start_date']) ? date('d-m-Y',strtotime($viewData['order']['analysis_start_date'])) : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">
                        ...
                        ?>
                        {{!empty($viewData['order']['is_amended_no']) && !empty($viewData['order']['orderAmendStatus']) ? $viewDate : !empty($viewData['order']['analysis_completion_date']) ? date('d-m-Y',strtotime($viewData['order']['analysis_completion_date'])) : '' }}
                    </td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                ...
                <tr>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['remarks']) ? $viewData['order']['remarks'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                ...
                <tr>
                    ...
                    <td align="left">{{!empty($viewData['order']['manufactured_by']) ? $viewData['order']['manufactured_by'] : 'N/A'}}</td>
                </tr>
                <tr>
                    <td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
                    ...
                    <td width="45%" align="left">{{!empty($viewData['order']['supplied_by']) ? $viewData['order']['supplied_by'] : 'N/A'}}</td>
                </tr>
            </table>

            <table width="100%" class="pdftable dash" style="border-collapse:collapse;text-align:center;">
                <tr>
                    <td align="left" style="border-top: 1px solid!important;border-right: 1px solid!important;border-bottom: 1px solid!important;border-left: 1px solid!important;padding-top:7px!important;padding-bottom:7px!important;" colspan="3"><b style="font-size:14px;display: inline-block;vertical-align: middle;">PART B : SUPPLIMENTARY INFORMATIONS</b></td>
                </tr>
                <tr>
