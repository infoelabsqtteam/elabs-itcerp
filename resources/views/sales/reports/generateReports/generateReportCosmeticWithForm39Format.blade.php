<html>
	...
	@page { margin: 180px 20px 230px 20px;font-size:13px;}
	#header {left: 0;position: fixed;right: 0;text-align: center;top: -175px;width: 100%;height:auto;}
	@elseif(!empty($viewData['order']['reportWithRightLogoWithoutNabl']) && !empty($nablLogoHeaderMarginStatus))
	@page { margin: 180px 20px 230px 20px;font-size:13px;}
	#header {left: 0;position: fixed;right: 0;text-align: center;top: -175px;width: 100%;height:auto;}
	@else
	@page { margin: 130px 20px 160px 20px;font-size:13px;}
	    ...
	    <tr>
		  ...
		  <p style="width:100%!important;margin-right:30px!important;">
			...
			@if($viewData['quality']['is_display_stamp'] == '1' && !empty($viewData['quality']['stampType']) && defined('GREEN_STANDARD_QUALITY'))
			   <span style="width: 50%; float: left;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img style="margin: 35px -20px;"  src="{{DOC_ROOT.'/public/images/quality/'.GREEN_STANDARD_QUALITY}}"/></span>
			@elseif($viewData['quality']['is_display_stamp'] == '1' && empty($viewData['quality']['stampType']) && defined('RED_STANDARD_QUALITY') && defined('NOT_STANDARD_QUALITY'))
			   <span style="width: 50%; float: left;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img style="margin: 35px -20px;"  src="{{DOC_ROOT.'/public/images/quality/'.RED_STANDARD_QUALITY}}"/></span>
			@else($viewData['quality']['is_display_stamp'] == '2' && defined('NOT_STANDARD_QUALITY'))
			   <span style="width: 50%; float: left;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img style="margin: 35px -20px;"  src="{{DOC_ROOT.'/public/images/quality/'.NOT_STANDARD_QUALITY}}"/></span>
			@endif
		     @else
...
<body>
   ...
   <div id="content">
	 ...
	 <table border="1" width="100%" class="pdftable" style="margin:0 auto;border-collapse:collapse;">
	    <tbody>       
	       <tr>
		  <td style="padding:0px;" width="100%" align="left" colspan="4"><b style="display: inline-block;vertical-align: middle;width: 100px;">Sample Name<?php echo Helper::getCustomerDefinedFieldSymbol('sample_description',$viewData['order']['customer_defined_fields']);?></b><b>:</b><b>{{!empty($viewData['order']['sample_description']) ? $viewData['order']['sample_description'] : ''}}</b></td>
	       </tr>				       
	       <tr>
		  <td style="padding:0px;" align="left" colspan="3"><b style="display: inline-block;vertical-align: middle;vertical-align: middle;width: 100px;">Supplied By<?php echo Helper::getCustomerDefinedFieldSymbol('supplied_by',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['supplied_by']) ? $viewData['order']['supplied_by'] : '' }}</td>
		  <td style="padding:0px;"><b style="display: inline-block;vertical-align: middle;width: 88px;">Report No.<?php echo Helper::getCustomerDefinedFieldSymbol('report_no',$viewData['order']['customer_defined_fields']);?></b><b>:</b>
	       ...
	       @if(!empty($viewData['order']['nabl_no']) && !empty($nablLogoHeaderMarginStatus))
	       <tr>
		  <td style="padding:0px;" align="left" colspan="3"><b style="display: inline-block;vertical-align: middle;width: 100px;">Manufactured By<?php echo Helper::getCustomerDefinedFieldSymbol('manufactured_by',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['manufactured_by']) ?  $viewData['order']['manufactured_by'] : ''}}</td>
		  <td style="padding:0px;"><b style="display: inline-block;vertical-align: middle;width: 88px;">Booking Code<?php echo Helper::getCustomerDefinedFieldSymbol('order_no',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['order_no']) ? $viewData['order']['order_no'] : ''}}</td>
	       </tr>
	       <tr>
		  <td style="padding:0px;" align="left" colspan="3"><b style="display: inline-block;vertical-align: middle;width: 100px;">Party Ref. Date<?php echo Helper::getCustomerDefinedFieldSymbol('letter_no',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['letter_no']) ?  $viewData['order']['letter_no'] : ''}}</td>
		  <td style="padding:0px;">
		     @if(!empty($reportWithRightLogo) && in_array($reportWithRightLogo,array('7','16'))) 
			<b style="display:inline-block;vertical-align: middle;width: 88px;font-size:12px!important;">NABL ULR No.<?php echo Helper::getCustomerDefinedFieldSymbol('nabl_no',$viewData['order']['customer_defined_fields']);?></b><b>:</b><span style="font-size:12.5px;">{{!empty($viewData['order']['nabl_no']) ? $viewData['order']['nabl_no'] : ''}}</span>
		     @else
			<b style="display:inline-block;vertical-align: middle;width: 88px;font-size:12px!important;"></b><span style="font-size:12.5px;"></span>
		     @endif
		  </td>
	       </tr>					  
	       <tr>
		  <td style="padding:0px;" align="left" colspan="4"><b style="display: inline-block;vertical-align: middle;width: 100px;">Submitted By<?php echo Helper::getCustomerDefinedFieldSymbol('customer_name',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['customer_name']) ? $viewData['order']['customer_name'] : ''}}{{!empty($viewData['order']['city_name']) ? '-'.$viewData['order']['city_name'] : ''}} ( {{!empty($viewData['order']['state_name']) ? $viewData['order']['state_name'] : ''}} ) </td>
	       </tr>
	       @else
		  <tr>
		     <td style="padding:0px;" align="left" colspan="3"><b style="display: inline-block;vertical-align: middle;width: 100px;">Manufactured By<?php echo Helper::getCustomerDefinedFieldSymbol('manufactured_by',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['manufactured_by']) ?  $viewData['order']['manufactured_by'] : ''}}</td>
		  ...
		  <tr>
		     <td style="padding:0px;" align="left" colspan="3"><b style="display: inline-block;vertical-align: middle;width: 100px;">Submitted By<?php echo Helper::getCustomerDefinedFieldSymbol('customer_name',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['customer_name']) ? $viewData['order']['customer_name'] : ''}}{{!empty($viewData['order']['city_name']) ? '-'.$viewData['order']['city_name'] : ''}} ( {{!empty($viewData['order']['state_name']) ? $viewData['order']['state_name'] : ''}} ) </td>
		     <td style="padding:0px;"><b style="display: inline-block;vertical-align: middle;width: 88px;">Party Ref. Date<?php echo Helper::getCustomerDefinedFieldSymbol('letter_no',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['letter_no']) ?  $viewData['order']['letter_no'] : ''}}</td>
		  </tr>
	       @endif				       
	       <tr>
		  <td align="left" style="padding:0px;" colspan="2" width="33.3%"><b style="display: inline-block;vertical-align: middle;width: 100px;">Mfg. Lic. No.<?php echo Helper::getCustomerDefinedFieldSymbol('mfg_lic_no',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['mfg_lic_no']) ? $viewData['order']['mfg_lic_no'] : ''}}</td>
		  ...
		  <td align="left" style="padding:0px;" width="33.3%"><b style="display: inline-block;vertical-align: middle;width: 88px;">Booking Date<?php echo Helper::getCustomerDefinedFieldSymbol('order_date',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['order_date']) ?  date(DATEFORMAT,strtotime($viewData['order']['order_date'])) :''}}</td>
	       </tr>				       
	       <tr>
		  <td align="left" style="padding:0px;" width="20%"><b style="display: inline-block;vertical-align: middle;width: 30px;">D/M<?php echo Helper::getCustomerDefinedFieldSymbol('mfg_date',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['mfg_date']) ? $viewData['order']['mfg_date'] : '-'}}</td>
		  <td align="left" style="padding:0px;" width="20%"><b style="display: inline-block;vertical-align: middle;width: 30px;">D/E<?php echo Helper::getCustomerDefinedFieldSymbol('expiry_date',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['expiry_date']) ? $viewData['order']['expiry_date'] : '-'}}</td>
		  <td align="left" style="padding:0px;" width="30%"><b style="display: inline-block;vertical-align: middle;width: 65px;">Batch Size<?php echo Helper::getCustomerDefinedFieldSymbol('batch_size',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['batch_size']) ? $viewData['order']['batch_size'] :'' }}</td>
		  <td align="left" style="padding:0px;" width="30%"><b style="display: inline-block;vertical-align: middle;width: 88px;">Sample Qty.<?php echo Helper::getCustomerDefinedFieldSymbol('sample_qty',$viewData['order']['customer_defined_fields']);?></b><b>:</b>{{!empty($viewData['order']['sample_qty']) ? $viewData['order']['sample_qty'] : ''}}</td>
	       </tr>
	       <tr>
		  <?php
		  ...
		  ?>		  
		  <td align="right" colspan="4" style="padding:0px;" width="100%" style="padding:0px;margin:0px;font-weight:bold;"><b>Date of completion of analysis : {{!empty($viewData['order']['orderAmendStatus'])  && !empty($viewData['order']['is_amended_no']) ? $viewDate :  date(DATEFORMAT,strtotime($viewData['order']['report_date']))}}</b></td>
	       </tr>				       
