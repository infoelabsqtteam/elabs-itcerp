<html>
   ...
   <style>
      ...
      @page { margin: 145px 20px 175px 20px;font-size:13px;}
      #header {left: 0;position: fixed;right: 0;text-align: center;top: -140px;width: 100%;height:auto;}
      @else
      @page { margin: 135px 20px 175px 20px;font-size:13px;}
               ...
               <tr>
                  ...
                  <td width="33.3%" align="center">
                     <div style="padding:5px;font-size: 13px;font-weight:bold;">
                        <p>Test Report No. : <span style="border-bottom:2px dotted #000 !important;">{{!empty($viewData['order']['report_no']) ? $viewData['order']['report_no'] : ''}}</span></p>
                        @if(!empty($viewData['order']['nabl_no']))
...
<div id="content">
   <div class="page-break-auto">         
      <table width="100%" class="pdftable" style="border-collapse:collapse;">
         ...
         <tr>
            <td colspan="2" style="padding:0px;"  align="left">
               <span style="display: inline-block;vertical-align: middle;width: 20% !important;">Test Report as per IS<?php echo Helper::getCustomerDefinedFieldSymbol('test_std_name',$viewData['order']['customer_defined_fields']);?></span><b>:</b>
                     ...
                     <table class="pdftable" width="100%" style="border-collapse:collapse;">
                          <tr>
                              <td width="100%" align="left" style="border: 1px solid #fff;overflow-wrap: break-word;word-wrap: break-word;vertical-align:middle;font-size:11px!important;" colspan="{{$colspanCounter}}">
                                 @if(!empty($viewData['order']['order_nabl_os_remark_scope']) && !empty(Helper::getCustomerDefinedFieldSymbol('sample_description',$viewData['order']['customer_defined_fields'])))
                                    '&#x2A;' represents categories/test parameters not covered under NABL&nbsp;&#124;&nbsp;'&#x2A;&#x2A;' represents outsource sample&nbsp;&#124;&nbsp;'&#x23;' represents Customer Defined Fields
                                 @elseif(!empty($viewData['order']['order_nabl_os_remark_scope']) && empty(Helper::getCustomerDefinedFieldSymbol('sample_description',$viewData['order']['customer_defined_fields'])))
                                    '&#x2A;' represents categories/test parameters not covered under NABL&nbsp;&#124;&nbsp;'&#x2A;&#x2A;' represents outsource sample
                                 @elseif(empty($viewData['order']['order_nabl_os_remark_scope']) && !empty(Helper::getCustomerDefinedFieldSymbol('sample_description',$viewData['order']['customer_defined_fields'])))
