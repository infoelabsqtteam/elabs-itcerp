            ...
            <tbody>
               ...
               <tr>
                  <td colspan="2" style="padding:0px;"  align="left">
                     <span style="display: inline-block;vertical-align: middle;width: 20% !important;">Customer Reference<?php echo Helper::getCustomerDefinedFieldSymbol('letter_no',$viewData['order']['customer_defined_fields']);?></span><b>:</b>
