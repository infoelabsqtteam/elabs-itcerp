...
<style>
   ...
   @if(!empty($viewData['order']['nabl_no']) && !empty($nablLogoHeaderMarginStatus))
	@page { margin: 220px 20px 230px 20px;font-size:13px;}
	#header {left: 0;position: fixed;right: 0;text-align: center;top: -215px;width: 100%;height:auto;}
	@else
   @page { margin: 120px 20px 220px 20px;font-size:13px;}
