<html>
    ...
    @page { margin: 300px 20px 230px 20px;font-size:13px;}
    #header {left: 0;position: fixed;right: 0;text-align: center;top: -290px;width: 100%;height:auto;}
    @else
    @page { margin: 285px 20px 220px 20px;font-size:13px;}	
					...
					<tr>
						<td width="50%" stlye="vertical-align:top">
							<p style="margin-bottom: 27px;display: table;vertical-align: top;">
								...
								<b style="display: table-cell;">{{!empty($viewData['order']['customer_name']) ? $viewData['order']['customer_name'] : ''}}
									<br />
							...
							<p>
								...
								<b style="">:</b>
								<b
									style="float:right;margin-right:50px;">{{!empty($viewData['order']['contact_name1']) ? $viewData['order']['contact_name1'] : ''}}</b>
							</p>
						</td>
						<td width="50%">
							...
							<p style="font-size:13px;padding:1!important;margin:0!important;"><b
									style="width:105px!important;float:left;">Date
									In</b><b>:</b>{{!empty($viewData['order']['booking_date']) ? date(DATEFORMAT,strtotime($viewData['order']['booking_date'])) : ''}}
							</p>
							<p style="font-size:13px;padding:1!important;margin:0!important;"><b
									style="width:105px!important;float:left;">Date
									Out</b><b>:</b>{{!empty($viewData['order']['report_date']) ? date(DATEFORMAT,strtotime($viewData['order']['report_date'])) : ''}}
							</p>
							<p style="font-size:13px;padding:1!important;margin:0!important;"><b
									style="width:105px!important;float:left;">Revised Date</b><b>:</b>/</p>
							<p style="font-size:13px;padding:1!important;margin:0!important;"><b
									style="width:105px!important;float:left;">Buyer</b><b>:</b>Reliance Ajio</p>
							<p style="font-size:13px;padding:1!important;margin:0!important;"><b
									style="width:105px!important;float:left;">working
									Days</b><b>:</b>{{!empty($viewData['order']['tat_days']) ? $viewData['order']['tat_days'] : '0'}}
							</p>
	...
	<div id="content">
		<div class="page-break-auto">
					...
					<td style="width: 50%;border:1px double">
						...
						<table style="width:100%">
							<tr>
								...
								<td width="50%">
									<p
										style="width: 50%;border-bottom:1px solid;text-align:center;float: right;min-height:50px;">
										X</p>
								</td>
							</tr>
							<tr>
			...
			<table border="1" style="width:100%;border-collapse:collapse;margin-top:30px;">
				<tr>
					...
					<td width="25%" style="padding:0 10px">
						{{!empty($viewData['order']['customer_name']) ? $viewData['order']['customer_name'] : ''}}</td>
				...
				<tr>
					...
					<td width="25%" style="padding:0 10px">Made in
						{{!empty($viewData['order']['country_name']) ? $viewData['order']['country_name'] : ''}}</td>
			...
			<table border="1" style="width:100%;border-collapse:collapse;margin:20px 0;">
				<tr>
					...
					<td width="75%" style="padding:0 10px">
						{{!empty($viewData['order']['p_category_name']) ? $viewData['order']['p_category_name'] : ''}}</td>
				</tr>
				<tr>
					<th align="left" width="25%" style="padding:0 10px">Test Requested</th>
					<td width="75%" style="padding:0 10px">
						{{!empty($viewData['order']['test_code']) ? $viewData['order']['test_code'] : ''}}</td>
				</tr>
				<tr>
			...
			<table border="1" style="width:100%;border-collapse:collapse;margin:10px 0;">
				...
				<tr>
					...
					<td width="75%" style="padding:0 10px">
						<table>
							<tr>
								<td style="min-width:70px;"><img src="{{url('/public/img/1.png')}}"
										style="max-width:60px;" /></td>
								<td style="min-width:70px;"><img src="{{url('/public/img/2.png')}}"
										style="max-width:60px;" /></td>
								<td style="min-width:70px;"><img src="{{url('/public/img/3.png')}}"
										style="max-width:60px;" /></td>
								<td style="min-width:70px;"><img src="{{url('/public/img/4.png')}}"
										style="max-width:60px;" /></td>
								<td style="min-width:70px;"><img src="{{url('/public/img/5.png')}}"
										style="max-width:60px;" /></td>
							</tr>
						</table>
						<p>Wash and Dry Inside Out Machine Wash Cold Dark Colors Separately</p>
						<p>Do Not Bleach Do Not Wring, Flat Dry In Shade Warm Iron When Needed Do Not Iron Directly On
							Prints (As claimed on label)</p>
					</td>
				</tr>
			</table>
			...
			<table style="width: 100%;border: 2px solid;margin-top:20px;padding: 10px;">
				<tr>
					<td colspan="2">
						<h3 style="text-align:center;margin:15px;">Signatories<br />Interstellar Testing Centre Pvt. Ltd.
						</h3>
					</td>
				</tr>
				<tr>
						...
						<p style="width: 200px;border-bottom:1px solid;height:100px">
							...
							<span
								style="display:inline-block;width:100%;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img
									style="margin:60px 0 !important;width:70px;height:30px;padding-top:-5px!important;"
					...
					<td width="50%" align="right">
						<p style="width: 200px;border-bottom:1px solid;float:right;height:100px;"
							...
							<span
								style="float:right;width:100%;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img
									style="margin:60px 0 !important;width:70px;height:30px;padding-bottom:-6px!important;"
				...
				<tr>
					...
					<td width="50%" align="right">
						<p style="width: 200px;text-align:center;float:right">
							{{!empty($viewData['orderTrackRecord']['finalizing']['username']) ? $viewData['orderTrackRecord']['finalizing']['username'] : ''}}
						</p>
					</td>
				</tr>
				<tr>
					<td width="50%" align="left">
						<p style="width: 200px;text-align:center">Senior Analyst</p>
					</td>
					<td width="50%" align="right">
						<p style="width: 200px;text-align:center;float:right">Tech. Manager</p>
					</td>
				</tr>
			</table>
			...
			<table border="1" style="border-collapse:collapse;width:100%;text-align:center;margin:20px 0" cellpadding="5px">
				...
				<tbody>
					...
					<tr>
						...
						<td <?php echo $hasLimitStyle;?>>
							{{!empty($orderParameterCategoryParameters['requirement_from_to']) ? trim($orderParameterCategoryParameters['requirement_from_to']) : ''}}
						</td>
						<td>
							<p>{{!empty($orderParameterCategoryParameters['test_result']) ? trim($orderParameterCategoryParameters['test_result']) :''}}
							</p>
						</td>
						<td>Pass</td>
					</tr>
			...
			<table style="width: 100%;margin:-30px 0 !important;padding: 10px;">
				...
				<tr>
					<td>
						<center><img src="{{url('/public/img/shirt.png')}}" style="max-width:230px;" /></center>
					</td>
				</tr>
			</table>
			<table style="width: 100%;margin: 10px 0;padding: 10px;">
				...
				<tr>
					<td width="50%">
						<center><img src="{{url('/public/img/wash.png')}}"
								style="border: 2px solid;max-width:230;margin-top:2px !important;" /></center>
					</td>
					<td width="50%">
						<center><img src="{{url('/public/img/barcode.png')}}"
								style="border: 2px solid;max-width:230;margin-top:2px !important;" /></center>
					</td>
				</tr>
				<tr>
