<html>
	...
	@else
	@page { margin: 260px 20px 220px 20px;font-size:13px;}
	...
	<div class="page-break-auto">
	    ...
	    <table width="100%" class="pdftable" border="1" style="border-collapse:collapse;">	    
			...
			<tr>
				...
				<td width="45%" align="left"> {{!empty($viewData['order']['is_amended_no']) && !empty($viewData['order']['orderAmendStatus']) ? $viewDate : !empty($viewData['order']['analysis_completion_date']) ? date('d-m-Y',strtotime($viewData['order']['analysis_completion_date'])) : '' }}</td>
			</tr>
			<tr>
				<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
	    ...
	    <table width="100%" class="pdftable" border="1" style="border-collapse:collapse;font-size:13px!important;margin-top:3px!important;">
