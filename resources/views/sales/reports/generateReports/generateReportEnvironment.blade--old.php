<html>
	...
	@page { margin: 322px 20px 230px 20px;font-size:13px;}
	...
	@else
		@if(!empty($notContainEquipment) || !empty($notContainLimit))
			@page { margin: 300px 20px 220px 20px;font-size:13px;}
			#header {left: 0;position: fixed;right: 0;text-align: center;top: -400px;width: 100%;height:auto;}
		@else
			@page { margin: 310px 20px 220px 20px;font-size:13px;}
			#header {left: 0;position: fixed;right: 0;text-align: center;top: -315px;width: 100%;height:auto;}
		@endif
	@endif
...
<div id="header">
				...
				<table width="100%" style="padding: 0px !important;">
					<tr>
						...
						<td width="33.3%" align="right">
							<b style="vertical-align: middle;display: block;margin-top: 10px;">Document QF : 2501<br> </b>
							<span style="font-weight:normal;display: inline-block;" align="right">
								@if(!empty($viewData['order']['nabl_no']) && !empty($nablLogoHeaderMarginStatus))
								<script type='text/php'>
								if(isset($pdf)){ 
									$font = $fontMetrics->get_font('serif','Normal');
									$size = 10;
									$y    = $pdf->get_height() - 715;
	...
	<table width="100%" border="1" style="padding:0px!important;border-collapse:collapse">
		<tr>
			...
			<td width="50%">
				<p style="font-size:13px;padding:1!important;margin:0!important;"><b
						style="width:105px!important;float:left;">Sample Reg.
						No.</b><b>:</b>{{!empty($viewData['order']['order_no']) ? $viewData['order']['order_no'] : ''}}
				</p>
				<p style="font-size:13px;padding:1!important;margin:0!important;"><b
						style="width:105px!important;float:left;">Sample Reg. Date
					</b><b>:</b>{{!empty($viewData['order']['order_date']) ? date(DATEFORMAT,strtotime($viewData['order']['order_date'])) : ''}}
				</p>
				<p style="font-size:13px;padding:1!important;margin:0!important;"><b
						style="width:105px!important;float:left;">Report
				...
				<p
					style="font-size:13px;padding:1!important;margin:0!important; @if((empty($viewData['order']['nabl_no'])) || (!empty($reportWithRightLogo) && $reportWithRightLogo == '17')) display:none; @endif">
					<b style="width:105px!important;float:left;">NABL ULR
						No.</b><b>:</b>{{!empty($viewData['order']['nabl_no']) ? $viewData['order']['nabl_no'] : ''}}
				</p>
				<p style="font-size:13px;padding:1!important;margin:0!important;"><b
						style="width:105px!important;float:left;">Customer Ref.
						No.</b><b>:</b>{{!empty($viewData['order']['reference_no']) ? $viewData['order']['reference_no'] : '-'}}
				</p>
				<p style="font-size:13px;padding:1!important;margin:0!important;"><b
						style="width:105px!important;float:left;">Letter
...
<div id="footer" class="footer-content">
			...
			<tr>
				<td width="33.3%" align="left" valign="bottom">
					...
					<p style="font-size:10px;padding-top:-5px!important;">
						<span
							style="float:right;width:100%;@if(empty($withOrWithoutSignature))visibility:hidden;@endif"><img
								style="width:70px;height:30px;padding-bottom:-6px!important;"
								alt="{{$viewData['order']['report_microbiological_name']}}"
								src="{{$viewData['order']['report_microbiological_sign_path']}}" /></span>
					</p>
				...
				<td width="33.3%" align="right" valign="bottom">
					<p style="font-size:10px;padding-top:-5px!important;">
						...
						@endif
						<span
							style="display:inline-block;width:100%;padding-top:-1px!important;">{{!empty($viewData['order']['finalizing_date']) ? date(DATEFORMAT,strtotime($viewData['order']['finalizing_date'])) : ''}}</span>
					</p>
					<p style="font-size:13px;padding-top:-1px!important;">
	...
	<div @if(!empty($hasContainHeaderFooter) &&
		in_array($hasContainHeaderFooter,array('2','3')))style="visibility: hidden;" @endif>
	...
	<div id="content">
		<div class="page-break-auto">
			<table class="pdftable" width="100%" border="1" style="border-collapse:collapse;">
				...
				<tr>
					<td align="left" width="50%" colspan="2"
						style="font-size:13px;padding-top:5px!important;padding-bottom:5px!important;"><b
							style="display: inline-block;vertical-align: middle;">Test Report as per IS </b><b
							style="display: inline-block;vertical-align: middle;">:</b>{{!empty($viewData['order']['test_std_name']) ? $viewData['order']['test_std_name'] : ''}}
					</td>
					<td align="left" width="50%" style="font-size:13px;"><b
							style="display: inline-block;vertical-align: middle;">With Amendment No.(s)
						</b><b>:</b>{{!empty($viewData['order']['with_amendment_no']) ? $viewData['order']['with_amendment_no'] : ''}}
					</td>
				</tr>
				<tr>
					<td align="left"
						style="border-bottom: 1px solid rgb(255, 255, 255);padding-top:7px!important;padding-bottom:7px!important;"
						width="50%" colspan="3"><b
							style="display: inline-block;vertical-align: middle;font-size:14px;">PART A : PARTICULARS OF
							SAMPLE SUBMITTED</b></td>
				</tr>
			...
			<table class="pdftable" width="100%" border="1" style="border-collapse:collapse;">
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{$serialAlphabet}})</td>
					<td width="50%" align="left">Nature of
						Sample<?php echo Helper::getCustomerDefinedFieldSymbol('sample_description',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['sample_description']) ? $viewData['order']['sample_description'] : ''}}
					</td>
				</tr>
				@endif

				@if(!empty($viewData['order']['sample_condition']))
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Sample
						Condition<?php echo Helper::getCustomerDefinedFieldSymbol('sample_condition',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['sample_condition']) ? $viewData['order']['sample_condition'] : 'N/A'}}
					</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Grade / Variety / Type / Class / Size
						etc.<?php echo Helper::getCustomerDefinedFieldSymbol('grade_type',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['grade_type']) ? $viewData['order']['grade_type'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Brand
						Name<?php echo Helper::getCustomerDefinedFieldSymbol('brand_type',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['brand_type']) ? $viewData['order']['brand_type'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Declared Values,if
						any<?php echo Helper::getCustomerDefinedFieldSymbol('declared_values',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td align="left">
						{{!empty($viewData['order']['declared_values']) ? $viewData['order']['declared_values'] : ''}}
					</td>
				</tr>
				@endif
				...
				<tr>
					...
					<td width="50%" align="left">Code
						No.<?php echo Helper::getCustomerDefinedFieldSymbol('barcode',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left"><img height="18px"
							src="{{!empty($viewData['order']['barcode']) ? $viewData['order']['barcode'] : ''}}">
					</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Batch
						Number<?php echo Helper::getCustomerDefinedFieldSymbol('batch_no',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['batch_no']) ? $viewData['order']['batch_no'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					...
					<td width="50%" align="left">
						D.O.M<?php echo Helper::getCustomerDefinedFieldSymbol('mfg_date',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['mfg_date']) ? $viewData['order']['mfg_date'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Date of
						Expiry<?php echo Helper::getCustomerDefinedFieldSymbol('expiry_date',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['expiry_date']) ? $viewData['order']['expiry_date'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Sample
						Quantity<?php echo Helper::getCustomerDefinedFieldSymbol('sample_qty',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['sample_qty']) ? $viewData['order']['sample_qty'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Batch
						Size/Location<?php echo Helper::getCustomerDefinedFieldSymbol('batch_size',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['batch_size']) ? $viewData['order']['batch_size'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Mode of
						Packing<?php echo Helper::getCustomerDefinedFieldSymbol('packing_mode',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['packing_mode']) ? $viewData['order']['packing_mode'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Date of
						Receipt<?php echo Helper::getCustomerDefinedFieldSymbol('order_date',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['order_date']) ? date('d-m-Y',strtotime($viewData['order']['order_date'])) : ''}}
					</td>
				</tr>
				@endif

				@if(!empty($viewData['order']['analysis_start_date']))
				<tr>
				...
				@if(!empty($viewData['order']['analysis_completion_date']))
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Seal (Intact/Not
						Intact/Unsealed)<?php echo Helper::getCustomerDefinedFieldSymbol('is_sealed',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">IO'S Signature
						(Signed/Unsigned)<?php echo Helper::getCustomerDefinedFieldSymbol('is_signed',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						@if(isset($viewData['order']['is_signed']))
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Any Other
						Information<?php echo Helper::getCustomerDefinedFieldSymbol('remarks',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['remarks']) ? $viewData['order']['remarks'] : ''}}</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Test Request Submitted
						By<?php echo Helper::getCustomerDefinedFieldSymbol('customer_name',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['customer_name']) ? $viewData['order']['customer_name'] : ''}}{{!empty($viewData['order']['city_name']) ? '-'.$viewData['order']['city_name'] : ''}}
						( {{ !empty($viewData['order']['state_name']) ? $viewData['order']['state_name'] : ''}} )</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Manufactured
						By<?php echo Helper::getCustomerDefinedFieldSymbol('manufactured_by',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td align="left">
						{{!empty($viewData['order']['manufactured_by']) ? $viewData['order']['manufactured_by'] : ''}}
					</td>
				</tr>
				@endif
				...
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">
						{{++$serialAlphabet}})</td>
					<td width="50%" align="left">Supplied
						By<?php echo Helper::getCustomerDefinedFieldSymbol('supplied_by',$viewData['order']['customer_defined_fields']);?>
					</td>
					<td width="45%" align="left">
						{{!empty($viewData['order']['supplied_by']) ? $viewData['order']['supplied_by'] : ''}}</td>
				</tr>
				@endif
			...
			<table width="100%" class="pdftable dash" style="border-collapse:collapse;text-align:center;">
				<tr>
					<td align="left"
						style="border-top: 1px solid!important;border-right: 1px solid!important;border-bottom: 1px solid!important;border-left: 1px solid!important;padding-top:7px!important;padding-bottom:7px!important;"
						colspan="3"><b style="font-size:14px;display: inline-block;vertical-align: middle;">PART B :
							SUPPLIMENTARY INFORMATIONS</b></td>
				</tr>
				<tr>
					<td align="center" width="5%"
						style="border-left: 1px solid!important;border-right: 1px solid #fff!important;padding-top:6px!important;padding-bottom:6px!important;">
						a.</td>
					<td align="left" width="74%" style="border-right: 1px solid #fff!important;">Reference to sampling
						procedure, whenever applicable</td>
					<td align="left" width="20%" style="border-right: 1px solid!important;">
						&nbsp;:&nbsp;{{!empty($viewData['order']['ref_sample_value_name']) ? $viewData['order']['ref_sample_value_name']  : ''}}
					</td>
				</tr>
				<tr>
					<td align="center" width="5%"
						style="border-right: 1px solid #fff!important;border-left: 1px solid!important;padding-top:6px!important;padding-bottom:6px!important;">
						b.</td>
					<td align="left" width="74%" style="border-right: 1px solid #fff!important;">Supporting documents
						for the measurement taken and results derived like graphs, tables, sketches and / or photographs
						as appropriate to test reports, if any</td>
					<td align="left" width="20%" style="border-right: 1px solid!important;">
						&nbsp;:&nbsp;{{!empty($viewData['order']['result_drived_value_name']) ? $viewData['order']['result_drived_value_name'] : ''}}
					</td>
				</tr>
				<tr>
					<td align="center" width="5%"
						style="border-right: 1px solid #fff!important;border-bottom: 1px solid!important;border-left: 1px solid!important;padding-top:6px!important;padding-bottom:6px!important;">
						c.</td>
					<td align="left" width="74%"
						style="border-right: 1px solid #fff!important;border-bottom: 1px solid!important;">Deviation
						from the test methods as prescribed in relevant ISS/WORK Instruments, if any</td>
					<td align="left" width="20%"
						style="border-bottom: 1px solid!important;border-right: 1px solid!important;">
						&nbsp;:&nbsp;{{!empty($viewData['order']['deviation_value_name']) ? $viewData['order']['deviation_value_name'] : ''}}
			...
			<table class="pdftable" width="100%"
				style="border:1px solid #000;border-collapse:collapse;margin-top:5px!important;">
				<tr>
								...
								<td>
									<table class="pdftable-general" width="100%" style="border-collapse:collapse;">
										...
										<tr>
											...
											<td style="padding:0px;" align="left" width="50%"><span
													style="vertical-align: middle;">:&nbsp;{{$parameterValues['test_result']}}</span>
											</td>
										</tr>
										@endforeach
									</table>
			...
			<table border="1" width="100%" class="pdftable" style="border-collapse:collapse;margin-top:5px!important;">
				...
				@foreach($viewData['orderParameterList']['descriptionWiseParameterList'] as $key =>
				$descriptionParaCategoryName)
				<tr>
				...
				<?php $charNum = 'a';?>
				@foreach($descriptionParaCategoryName['categoryParams'] as $orderParaKey =>
				$descriptionParaCategoryParameters)
				<tr>
					...
					<td class="text-justify parameter" colspan="{{$colspanCounter-2}}" align="left"
				...
				@foreach($viewData['orderParameterList']['disciplineWiseParametersList'] as $key =>
				$orderParameterCategoryName)
				...
				<tr>
					...
					<th class="category" align="left" colspan="{{$colspanCounter-1}}"
			...
			<table border="1" width="100%" class="pdftable"
				style="margin:0 auto;border-collapse:collapse;margin-top:5px!important;">
				<tr>
					<td colspan="{{$colspanCounter}}" style="border: 1px solid #fff;">
						<table class="pdftable" width="100%" style="border-collapse:collapse;">
							<tr>
								<td width="100%" align="left"
									style="border: 1px solid #fff;overflow-wrap: break-word;word-wrap: break-word;vertical-align:middle;font-size:11px!important;"
			...
			<table class="pdftable" width="100%" style="border-collapse:collapse;margin-top:5px!important;">
				...
				<tr>
					<td width="100%" align="left"
						...
						colspan="{{$colspanCounter}}"><b style="font-size:14px!important;vertical-align: middle;">NOTE
							:</b> <span
				...
				<tr>
					<td width="100%" align="left"
						style="border: 1px solid #fff;overflow-wrap: break-word;word-wrap: break-word;vertical-align: middle;"
						colspan="{{$colspanCounter}}"><b
							style="font-size:14px!important;vertical-align: middle;">REMARKS :</b><span
							style="vertical-align: middle;">{{!empty($viewData['order']['remark_value']) ? $viewData['order']['remark_value'] : ''}}</span>
					</td>
				</tr>
				<tr>
					<td width="100%" align="left" style="visibility:hidden;" colspan="{{$colspanCounter}}">&nbsp;</td>
				...
				<tr>
					<td width="100%" align="center"
						style="border: 1px solid #fff;overflow-wrap: break-word;word-wrap: break-word;vertical-align: middle;"
						colspan="{{$colspanCounter}}"><b
							style="font-size:14px!important;vertical-align: middle;">*****End Of Report*****</td>
				</tr>
			</table>
			<!--/NOTE & REMARKS-->
