<html>
    ...
    @else
    @page { margin: 320px 20px 220px 20px;font-size:13px;}
...
<body>
	...
	<div class="page-break-auto">
	    ...
	    <table class="pdftable" width="100%" border="1" style="border-collapse:collapse;">	    
			...
			<tr>
				<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
				<td width="50%" align="left">Date of Start<?php echo Helper::getCustomerDefinedFieldSymbol('order_date',$viewData['order']['customer_defined_fields']);?></td>
	    ...
	    <table class="pdftable" border="1" width="100%" style="border-collapse:collapse;margin-top:5px!important;">
			...
			@if(!empty($viewData['orderParameters']))
				...
				<tr>
					...
					<th class="category" align="left" colspan="{{$colspanCounter-1}}" style="padding:2px;">{{trim($orderParameterCategoryName['categoryName'])}}{{!empty($orderParameterCategoryName['categoryNameSymbol']) ? trim($orderParameterCategoryName['categoryNameSymbol']) : ''}}</th>
				</tr>
