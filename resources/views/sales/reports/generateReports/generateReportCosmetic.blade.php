...
<div id="header">
    ...
    <div class="header-content" @if(!empty($hasContainHeaderFooter) && in_array($hasContainHeaderFooter,array('2','3')))style="visibility: hidden;"@endif>
		<table width="100%">
			<tr>
				<td align="left" width="20%" class="left-content"><img class="leftSection" src="../public/images/template_logo.png" style="width:120px" /></td>
				<td align="center" width="65%" class="middle-content"><h3 class="middleSection">Interstellar Testing Centre Pvt. Ltd.</h3></td>
				<td align="right" width="15%" class="right-content"><img class="rightSection" src="../public/images/report_logo_right_01_v1.jpg"  /></td>
			</tr>
		</table>
    </div>
...
<div id="footer" class="footer-content">
   ...
   <div @if(!empty($hasContainHeaderFooter) && in_array($hasContainHeaderFooter,array('2','3')))style="visibility: hidden;"@endif>
	 ...
	 <tr>
		 ...
		 <h5 style=""><b>(ISO 9001:2008 & 14001:2015 OHSAS 18001:2007 Certified Laboratory)</b></h5>
		 <h5><b>(A Government Approved Test House)</b></h5>
		 <h5><b>86, Industrial Area, Phase-1, Panchkula-134109 (Haryana)</b></h5>
		 <p>Phone : (O) 0172-2561543, 2565825</p>
		 <p>Visit us : <span style="text-decoration:underline">www.itclabs.com</span>&nbsp; <b>Email :</b> customersupport@itclabs.com</p>
	     </td>
	     <td align="left" width="50%">
		 <h3>Disclaimer :</h3>
		 <ul>
		     <li>Sample (s) not drawn by us unless otherwise stated.</li>
		     <li>Total Liability of this Laboratory is limited to the Invoiced amount.</li>
		     <li>Test certificates in full or parts shall not be used for promotional or publicity purpose.</li>
		     <li>If sample is not consumed during analysis,it will be stored as per SOP of controlled sample management.</li>	
		 </ul>
	     </td>
	 </tr>
      </table>
		...
		<div class="page-break-auto">
			...
			<table class="pdftable" width="100%" border="1" style="border-collapse:collapse;">	
				...
				<tr>
					...
					<td width="45%" align="left"><img height="18px" src="{{!empty($viewData['order']['barcode']) ? $viewData['order']['barcode'] : 'N/A'}}">
					</td>
				</tr>
				<tr>
					<td width="5%" style="padding-top:5px!important;padding-bottom:5px!important;" align="center">{{++$serialAlphabet}})</td>
				...
				@if(!empty($viewData['orderParameters']))
					...
					@if(!empty($orderParameterCategoryName['categoryParams']))
						...
						<tr>
							...
							<td align="center" class="requirementName"<?php echo $hasLimitStyle;?>>{{ isset($orderParameterCategoryParameters['requirement_from_to']) && strlen($orderParameterCategoryParameters['requirement_from_to']) > '0' ? trim($orderParameterCategoryParameters['requirement_from_to']) : ''}}</td>
