<html>
   ...
   <style>
	...
	@else
	@page { margin: 205px 20px 265px 20px;font-size:13px;}
...
<div id="header">
    ...
    <table width="100%" style="border-collapse:collapse;@if(!empty($viewData['order']['nabl_no']) && !empty($nablLogoHeaderMarginStatus)) margin-top:-8px!important; @else margin-top:-5px!important; @endif @if(!empty($hasContainHeaderFooter) && in_array($hasContainHeaderFooter,array('3')))visibility: hidden;@endif">
        <tr>
...
<body>
    ...
    <div id="content">
        <div class="page-break-auto">
            ...
            <table width="100%" border="1" class="pdftable" style="margin:0 auto;border-collapse:collapse;margin-top:5px!important;">
                ...
                <tr>
                    <td colspan="{{$colspanCounter}}" style="padding-top:5px!important;border: 1px solid #fff;margin-top:10px!important;">
                        <table class="pdftable" width="100%" style="border-collapse:collapse;">
                            ...
                            <tr>
                                <td width="100%" align="center" colspan="{{$colspanCounter}}" style="margin-top:10px!important;border: 1px solid #fff;overflow-wrap: break-word;word-wrap: break-word;vertical-align: middle;" colspan="6"><b style="font-size:14px!important;vertical-align: middle;">*****End of Report*****</td>
                            </tr>
                        </table>
                    </td>
                </tr>
