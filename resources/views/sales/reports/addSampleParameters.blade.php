                                        ...
                                        <tbody>
                                            <tr ng-if="categoryParameters.categoryParams" ng-repeat="subCategoryParameters in categoryParameters.categoryParams">
                                                ...
                                                <td data-title="Test Result">                                                    
                                                    ...
                                                    @else                                                        
                                                        <span ng-if="[[subCategoryParameters.has_employee_equipment_type]] == 1">
                                                            <input type="text"                                                               
                                                               class="form-control" id="test_result[[subCategoryParameters.analysis_id]]"
                                                               name="test_result['[[subCategoryParameters.analysis_id]]']"
                                                               placeholder="enter test result"
                                                               value="[[subCategoryParameters.test_result ? subCategoryParameters.test_result : '']]">
                                                        </span>
                                                    ...
                                                    @endif
                                                    <input type="hidden" id="test_performed_by" ng-model="report.test_performed_by" name="test_performed_by" value="{{$user_id}}">
                                                    <input type="hidden" id="order_id" ng-model="report.order_id" name="order_id" ng-value="viewOrderReport.order_id">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
