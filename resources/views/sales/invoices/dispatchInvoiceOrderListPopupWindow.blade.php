<div class="modal fade" data-backdrop="static" data-keyboard="false" id="dispatchInvoiceOrderListPopupWindow" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
	<div class="modal-dialog">
		<div class="row modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title text-left"><span ng-click="funGetDispatchDetail(dispatchOrder.invoice_id)">Dispatch Detail : <span ng-if="dispatchOrder.invoice_no" ng-bind="dispatchOrder.invoice_no"></span></span></h4>
			...
			<div id="modal-body-diol" class="modal-body">
				...
				<!--Dispatch Form--> 
				<div class="row" ng-if="dispatchOrder.invoice_status == 1">
				...
				<!--Dispatch Detail--> 
				<div class="mT20" ng-if="dispatchInvoiceOrderList.length">
					<table class="col-sm-12 table-striped table-condensed cf font13">
						...
						<tbody>
							<tr ng-repeat="dispatchInvoiceOrderObj in dispatchInvoiceOrderList | orderBy:predicate:reverse track by $index">
								<td data-title="S.No." class="ng-binding">[[$index + 1]]</td>
								<td data-title="AR Bill No." class="ng-binding">[[dispatchInvoiceOrderObj.ar_bill_no]]</td>
								<td data-title="Dispatch Date" class="ng-binding">[[dispatchInvoiceOrderObj.dispatch_date]]</td>
								<td data-title="Dispatch By" class="ng-binding">[[dispatchInvoiceOrderObj.dispatched_by]]</td>     
							</tr>
							<tr ng-if="!dispatchInvoiceOrderList.length"><td colspan="4">No record found.</td></tr>
						</tbody>							
					</table>
				</div>
				<!--/Dispatch Detail-->
