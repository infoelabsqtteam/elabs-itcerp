		...
		<tfoot>
			...
			<tr>
				...
				<td colspan="2" class="text-right">
					...
					<h5 ng-if="sgstRate && sgstAmount"><b>State Goods & Service Tax (</b><input ng-class="erpEditInvoicesForm.sgstRate.$invalid ? 'border-danger' : '' " type="text" class="invoice-edit form-control" ng-required='true' ng-model="sgstRate" name="sgstRate" ng-value="sgstRate"><b>%)</b></h5>
					<h5 ng-if="cgstRate && cgstAmount"><b>Central Goods & Service Tax (</b><input ng-class="erpEditInvoicesForm.cgstRate.$invalid ? 'border-danger' : '' "  type="text" class="invoice-edit form-control" ng-required='true' ng-model="cgstRate" name="cgstRate" ng-value="cgstRate"><b>%)</b></h5>
					<h5 ng-if="igstRate && igstAmount"><b>Integrated Goods & Service Tax (</b><input ng-class="erpEditInvoicesForm.igstRate.$invalid ? 'border-danger' : '' "  type="text" class="invoice-edit form-control" ng-required='true' ng-model="igstRate" name="igstRate" ng-value="igstRate"><b>%)</b></h5>
				</td>
				<td>
					...
					<h5 class="text-right" ng-if="sgstRate && sgstAmount"><b>[[sgstAmount]]</h5>
					<h5 class="text-right" ng-if="cgstRate && cgstAmount"><b>[[cgstAmount]]</h5>
					<h5 class="text-right" ng-if="igstRate && igstAmount"><b>[[igstAmount]]</h5>
				</td>
			</tr>
			
			<tr>
				<td rowspan="2" colspan="2" style="font-size:13px!important;"></td>	
				<td colspan="2"><h5 class="text-right"><b>GRAND TOTAL</b></h5></td>
				<td><h5 class="text-right"><b>[[netTotal]]</b></h5></td>
			</tr>
