<?php
/****************************************
* Invoice Generation Blade with State Wise
		...
		<div class="page-break-auto">			
			<table border="1" class="pdftable" width="100%" style="margin:0;border-collapse:collapse">
				<tbody>
					...
					<tr>
						<th width="5%!important;"  align="center">S.No.</th>
						<th width="30%!important;" align="left">Sample Name</th>
						<th width="20%!important;" align="left">Batch No.</th>
						<th width="15%!important;"  align="left">Report No.</th>
						<th width="10%!important;" align="left">Basic Rates</th>
						<th width="10%!important;" align="left">Tax Amount</th>
						<th width="10%!important;" align="left">L1 Final Amount</th>
					</tr>
						...
						@if(!empty($viewData['invoiceHeader']['billing_type']) && $viewData['invoiceHeader']['billing_type'] == '5')
							@foreach($viewData['invoiceBody'] as $PONumberKey => $invoiceBodyPoAll)
								<tr>
									...
									<td align="left" colspan="6" style="font-size:11px!important;font-weight:bold;overflow-wrap: break-word;word-wrap: break-word;">{{$PONumberKey}}</td>
								</tr>
								@if(!empty($invoiceBodyPoAll) && is_array($invoiceBodyPoAll))
									@foreach($invoiceBodyPoAll as $key => $invoiceBody)
										<tr>
											...
											<td align="right" style="font-size:12px!important;overflow-wrap:break-word;word-wrap: break-word;">{{$invoiceBody['basic_rate']}}</td>
											<td align="right" style="font-size:12px!important;overflow-wrap:break-word;word-wrap: break-word;">{{$invoiceBody['service_tax']}}</td>
											<td align="right" style="font-size:12px!important;overflow-wrap:break-word;word-wrap: break-word;">{{$invoiceBody['l1_final_amount']}}</td>
										</tr>
									@endforeach
								@endif
							@endforeach
					...
					<tr>
						<td colspan="3" style="vertical-align: top;">
							...
							<p>{{ucwords($viewData['invoiceFooter']['net_total_in_words_wsw'])}}</p>
						</td>
						<td align="right" colspan="3">
							<b style="text-align:right!important">GRAND TOTAL</b>
						</td>
						<td align="right" colspan="1">
							<b style="text-align:right!important;"><b>{{$viewData['invoiceFooter']['net_total_wsw']}}</b>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="4" style="vertical-align: top;border:1px solid;border-bottom:0px!important">
							<h5 style="text-align:right!important;margin-top:10px !important;"><b>For INTERSTELLAR TESTING CENTRE PVT. LTD.</b></h5>
						</td>
					</tr>
					<tr>   
						<td colspan="3" style="font-size: 10px;border:1px solid">
						...
						<td colspan="4" style="vertical-align: bottom;border:1px solid;border-top:0px!important" valign="bottom">
							<div style="font-size:10px;padding-top:10px!important;float:right!important;">
								...
								<p style="float:right;width:100%;@if(!empty($hasContainHeaderFooter) && $hasContainHeaderFooter == '3');@endif"><img style="width: 70px; height: 30px; padding-left:30px;" alt="{{$viewData['invoiceHeader']['invoice_by']}}" src="{{$viewData['invoiceHeader']['user_signature_file_url']}}"/></p>
								@endif
