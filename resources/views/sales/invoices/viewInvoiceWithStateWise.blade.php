	...
	<table class="table table-bordered" style="margin:0;">
		<thead>
			...
			<tr>
			      ...
			      <th class="text-center">L1 Final Amount</th>
		       </tr>
		</thead>
		...
		<tbody ng-if="billingType != 5" style="min-height: 500px;">
			<tr ng-repeat="invoiceBodyObj in invoiceBody track by $index">
				...
				<td class="text-right">[[invoiceBodyObj.basic_rate]]</td>
				<td class="text-right">[[invoiceBodyObj.service_tax]]</td>
				<td class="text-right">[[invoiceBodyObj.l1_final_amount]]</td>
			</tr>
		</tbody>
		<!--If Billing Type is Daily,Monthly,Weekly and Regular-->
		...
		<tfoot>
			...
			<tr>
				<td class="text-left" colspan="7"><h4>Total Amount (In Words) : <span class="pL10">[[netTotalInWord]]</span></h4></td>
			</tr>
			
			<tr>
				<td rowspan="2" colspan="3" style="font-size:13px!important;">
