...
<div id="header">
	...
	<div style="font-size:15px!important;text-align:center!important;font-weight:bold;">Credit Note : {{$viewData['creditNoteHeader']['credit_note_no']}}</div>
</div>
<!--- /header-->
				...
				<tbody>
					<tr>
						...
						<th colspan="2" style="text-align:center!important">
							<p><b>Invoice No.</b></p>
							<h4 style="margin: 0px;">{{$viewData['creditNoteHeader']['invoice_no']}}</h4>
						</th>
					</tr>
					...
					<tr>
						<th colspan="2" style="text-align:center!important">
							<p><b>Dated</b></p>
							<h4 style="margin: 0px;">{{date('d-m-Y',strtotime($viewData['creditNoteHeader']['invoice_date']))}}</h4>
						</th>
					</tr>
					...
					@if(!empty($viewData['creditNoteBody']))
						@if(!empty($viewData['creditNoteHeader']['billing_type']) && $viewData['creditNoteHeader']['billing_type'] == '5')
							@foreach($viewData['creditNoteBody'] as $PONumberKey => $invoiceBodyPoAll)
								<tr>
					...
					<tr>
						...
						<td colspan="2" style="text-align:right!important">
							...
							@if(!empty(round($viewData['creditNoteFooter']['discount'])))
							<h5 style="padding: 5px; margin: 0px ! important;">
							    <b>Discount</b>
							    @if(!empty($viewData['creditNoteFooter']['discount_text']))
							    <b>{{$viewData['creditNoteFooter']['discount_text']}}</b>
							    @endif
							</h5>
							@endif
							@if(!empty(round($viewData['creditNoteFooter']['net_amount'])))
							<h5 style="padding: 5px; margin: 0px ! important;"><b>Net Total</b></h5>
							@endif
							@if(!empty(round($viewData['creditNoteFooter']['surcharge_amount'])))
							<h5 style="padding: 5px; margin: 0px ! important;"><b>Surcharge Amount</b></h5>
							@endif
							@if(!empty(round($viewData['creditNoteFooter']['extra_amount'])))
						...
						<td>
							...
							@if(!empty(round($viewData['creditNoteFooter']['discount'])))
							<h5 style="padding: 5px; margin: 0px ! important;text-align:right!important;"><b>{{$viewData['creditNoteFooter']['discount']}}</b></h5>
							@endif
							@if(!empty(round($viewData['creditNoteFooter']['net_amount'])))
							<h5 style="padding: 5px; margin: 0px ! important;text-align:right!important;"><b>{{$viewData['creditNoteFooter']['net_amount']}}</b></h5>
							@endif
							@if(!empty(round($viewData['creditNoteFooter']['surcharge_amount'])))
							<h5 style="padding: 5px; margin: 0px ! important;text-align:right!important;"><b>{{$viewData['creditNoteFooter']['surcharge_amount']}}</b></h5>
							@endif
							@if(!empty(round($viewData['creditNoteFooter']['extra_amount'])))
							<h5 style="padding: 5px; margin: 0px ! important;text-align:right!important;"><b>{{$viewData['creditNoteFooter']['extra_amount']}}</b></h5>
							@endif
							@if(!empty($viewData['creditNoteFooter']['sgst_rate']) && !empty($viewData['creditNoteFooter']['sgst_amount']))
