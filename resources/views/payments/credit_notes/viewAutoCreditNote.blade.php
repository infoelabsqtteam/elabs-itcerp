<div class="row" ng-if="IsViewAutoCreditNoteDetail">
		...
		<div class="table-responsive">
			<table class="table table-bordered" style="margin:0;">
				<thead>
					...
					<tr>
						<th colspan="2">
							<h4 class="col-md-12 text-left font16"><strong>Invoice No.:&nbsp;</strong>[[creditNoteHeaders.invoice_no]]</h4>
							<h4 class="col-md-12 text-left font16"><strong>Dated</strong>:&nbsp;[[creditNoteHeaders.invoice_date | date : 'dd-MM-yyyy']]</h4>
						</th>
					</tr>
					<tr>
				...
				<tbody ng-if="creditNoteHeaders.billing_type != 5" style="min-height: 500px;">
				...
				<tbody ng-repeat="(key,creditNoteBodyObj) in creditNoteBody" ng-if="creditNoteHeaders.billing_type == 5" style="min-height: 500px;">
					<tr>
						<td></td>
						<td colspan="4"><strong>[[key]]</strong></td>
					</tr>
					<tr ng-repeat="creditNoteObj in creditNoteBodyObj track by $index">
						<td class="text-center">[[$index+1]].</td>
						<td class="text-left">[[creditNoteObj.name_of_product]]</td>
						<td class="text-center">[[creditNoteObj.batch_no]]</td>
						<td class="text-center">[[creditNoteObj.order_no]]</td>
				...
				<tfoot>					
					<tr>
						...
						<td colspan="2" class="text-right">
							...
							<h5 class="font14" ng-if="creditNoteFooters.discount != 0.00"><strong>Discount&nbsp;</strong><strong ng-if="creditNoteFooters.discount_text != 0">[[discountText]]</strong></h5>
							<h5 class="font14" ng-if="creditNoteFooters.net_amount"><strong>Net Total</strong></h5>
							<h5 class="font14" ng-if="creditNoteFooters.surcharge_amount != 0.00"><strong>Surcharge Amount</strong></h5>
							<h5 class="font14" ng-if="creditNoteFooters.extra_amount != 0.00"><strong>Convenience & Sampling Amount</strong></h5>
						...
						<td>
							...
							<h5 class="text-right font14" ng-if="creditNoteFooters.discount != 0.00"><strong>[[creditNoteFooters.discount]]</strong></h5>
							<h5 class="text-right font14" ng-if="creditNoteFooters.net_amount"><strong>[[creditNoteFooters.net_amount]]</strong></h5>
							<h5 class="text-right font14" ng-if="creditNoteFooters.surcharge_amount != 0.00"><strong>[[creditNoteFooters.surcharge_amount]]</strong></h5>
							<h5 class="text-right font14" ng-if="creditNoteFooters.extra_amount != 0.00"><strong>[[creditNoteFooters.extra_amount]]</strong></h5>
					...
					<tr>
						...
						<td rowspan="2" colspan="3">
							...
							<div style="font-size:10px;margin-top: 130px;float:right!important;">
							     <p ng-if="creditNoteHeaders.user_signature" style="float: right; width: 100%; padding-left: 21px;"><img style="height: 30px; width: 100px;" alt="[[creditNoteHeaders.invoice_by]]" ng-src="[[creditNoteHeaders.user_sign_path]][[creditNoteHeaders.user_signature]]"/></p>
