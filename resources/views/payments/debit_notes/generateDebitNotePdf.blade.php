...
<div id="header">	
	...
	<div style="font-size:15px!important;text-align:center!important;font-weight:bold;">Debit Note : {{$viewData['debitNoteHeader']['debit_note_no']}}</div>
</div>
<!--- /header-->
				...
				<tbody>
					<tr>
						...
						<th colspan="2" style="text-align:center!important">
							<p><b>Invoice No.</b></p>
							<h4 style="margin: 0px;">{{$viewData['debitNoteHeader']['invoice_no']}}</h4>
						</th>
					</tr>
					<tr>
						<th colspan="2" style="text-align:center!important">
							<p><b>Dated</b></p>
							<h4 style="margin: 0px;">{{date('d-m-Y',strtotime($viewData['debitNoteHeader']['invoice_date']))}}</h4>
						</th>
					</tr>
