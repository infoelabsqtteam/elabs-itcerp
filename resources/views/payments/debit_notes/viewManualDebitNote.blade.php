<div class="row" ng-if="IsViewManualDebitNoteDetail">
		...
		<div class="table-responsive">
			<table class="table table-bordered" style="margin:0;">
				<thead>
					...
					<tr>
						<th colspan="2">
							<p class="col-md-12 text-left"><strong>Reference No./Invoice No.</strong></p>
							<h4 ng-if="debitNoteHeaders.invoice_no" class="col-md-12 text-left font16">[[debitNoteHeaders.invoice_no]]</h4>
							<h4 ng-if="debitNoteHeaders.invoice_date" class="col-md-12 text-left font16"><strong>Dated:&nbsp;</strong>[[debitNoteHeaders.invoice_date | date : 'dd-MM-yyyy']]</h4>
						</th>
					</tr>
				...
				<tfoot>
					<tr>
						<td colspan="2"><h4>Total Amount (In Words) Rs.</h4><p>[[debitNoteFooters.net_total_in_words]]</p></td>
