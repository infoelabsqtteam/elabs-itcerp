        ...
        <div class="header">
            ...
            <div class="navbar-form navbar-right" role="search">
                <div class="nav-custom" style="margin-right: -6px;">
                    ...
                    <select class="form-control width40 hidden" ng-model="product_category.selectedOption" ng-options="item.name+' ('+item.parent_category_name+')' for item in productCategories track by item.id" ng-change="getStandatdProductTest(product_category.selectedOption.id)">
                        <option value="">Select Product Category</option>
                    </select>
                    <input type="text" class="seachBox form-control ng-pristine ng-untouched ng-valid" placeholder="Search" ng-change="funFilterStandatdProductTest(ProductCategoryId,searchProductTest)" ng-model="searchProductTest" name="keyword">
                    ...
                    <input array type="hidden" value="[[ProductCategoryId]]" name="product_category_id" ng-model="ProductCategoryId">
                </div>
            </div>
            ...
            <table class="col-sm-12 table-striped table-condensed cf">
                ...
                <tbody>
                    <tr ng-hide="multiSearchTr">
                        ...
                        <td><select ng-change="getMultiSearch()" name="search_status" class="form-control multiSearch" ng-model="searchStdTest.search_status" ng-options="status.name for status in statusList track by status.id">
                    ...
                    <tr ng-if="!allList.length" class="noRecord">
