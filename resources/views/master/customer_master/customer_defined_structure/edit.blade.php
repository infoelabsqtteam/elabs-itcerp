				...
				<div class="row">
					...
					<div class="col-xs-3">
						...
						<select class="form-control"
								...
								id="discount_type_id"
								ng-change="funGetDiscountType(editCustomerInvoicing.discount_type_id.selectedOption.id,'edit')"
								ng-required='true'
					...
					<div class="col-xs-2 form-group" ng-init="addTestParameter.test_parameter_invoicing=true">
						...
						<label for="tat_editable">
						    <input type="checkbox" ng-checked="tatEditableSelected" ng-model="editCustomerInvoicing.tat_editable" value="1" name="tat_editable" id="tat_editable">Check for TAT Editable
						</label>
					    </div>
					</div>
					<!--/Parameter Invoicing-->
