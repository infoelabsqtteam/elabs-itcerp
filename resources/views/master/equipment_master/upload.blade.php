<div class="row" ng-hide="IsViewEquipmentTypeUpload">
	<div class="row panel panel-default">
		<div class="panel-body" ng-model="uploadEquipmentFormDiv" >
			<form name='equipmentTestCSVForm' id='equipmentTestCSVForm' novalidate>
				...
				<div class="row" ng-if="!IsViewEquipmentTypeUpload">							  
					<div class="form-group" style="margin-right: 132px;">
						<input type="file" name="equipmentFile" id="equipmentTypesFile" class="uploadfile">
					...
					<a class="right-nav downloadTestCsv" download href="{{url('public/sample/equipment_type.csv')}}">Download Equipment Types Sample</a>
				</div>
			</form>	
			...
			<script>
				...
				$(document).on('change', '.uploadfile', function(){
					  $('.browseFileInput').val($('#equipmentTypesFile').val().replace(/C:\\fakepath\\/i, ''));
				});
			</script>
		</div>
	</div>
