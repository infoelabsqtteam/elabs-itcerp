	...
	<div class="panel-body">
		...
		<div class="row">
			...
			<select
			    ...
			    id="cir_customer_id"
			    ng-required="true"
			    ng-model="editCustomerWiseProductRate.cir_customer_id.selectedOption"
			    ng-options="customerList.name for customerList in customerEditListData track by customerList.id">
		...
		<div class="row">
			...
			<select
			    class="form-control"
			    name="cir_city_id"
			    ng-model="editCustomerWiseProductRate.cir_city_id.selectedOption"
			    id="cir_city_id"
			    ng-required='true'
			    ng-options="item.name for item in stateCitiesList track by item.id">
			...
			<span ng-messages="erpEditCustomerWiseProductRateForm.cir_city_id.$error" ng-if='erpEditCustomerWiseProductRateForm.cir_city_id.$dirty  || erpEditCustomerWiseProductRateForm.$submitted' role="alert">
		     ...
		     <!-- <div class="col-xs-3 form-group">
			    ...
			    ng-init="for_fixed_rate"
			    ng-model="for_fixed_rate"
			    name="for_fixed_rate">&nbsp;For Fixed Rate
		    </div> -->
		</div>
		<!--/City--->
		...
		<div class="row">
			...
			<select class="form-control"
					...
					ng-model="editCustomerWiseProductRate.cir_product_category_id.selectedOption"
		...
		<!-- Rates-->
                <div class="row">
                    ...
                    <div class="col-xs-6 form-group">
                        <input type="text"
                            id="invoicing_rate"
                            ng-model="editCustomerWiseProductRate.invoicing_rate"
                            ng-required="true"
                            name="invoicing_rate"
                            class="form-control"
                            placeholder="Rate">
