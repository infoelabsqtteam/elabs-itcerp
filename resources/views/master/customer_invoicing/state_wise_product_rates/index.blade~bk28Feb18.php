...
<div class="container" ng-controller="invoicingTypeStateWiseProductsController" ng-init="funGetStateWiseProductRates(cirStateID,'1');funGetProductWiseStatesList('0');funGetParentCategory();funGetStateAccToDept('1')">
