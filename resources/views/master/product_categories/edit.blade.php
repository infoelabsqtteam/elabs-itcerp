<div ng-show="{{defined('EDIT') && EDIT}}">
	<div class="panel panel-default" ng-hide="editProductFormDiv" >
		<div class="panel-body" id="editProductCatDiv" ng-model="editProductFormDiv">
			...
			<label for="submit">{{ csrf_field() }}</label>	
				...
				<div class="row">
					...
					<div class="col-xs-2">
						...
						<button title="Close" type='button'  class='mT26 btn btn-default' ng-click='backToAddForm()' > Close </button>
					</div>
				</div>
			</form>	
		</div>
