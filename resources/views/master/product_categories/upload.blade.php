		...
		<div class="panel-body">
			<form name='productTestCSVForm' id='productTestCSVForm' novalidate>
				...
				<div class="row header1">
					<strong class="pull-left headerText">Upload Product Categories</strong>								
					<strong class="pull-right headerText">
						<input type="submit" ng-click="backToAddForm()" value="Back" class="uploaCSVbtn btn btn-primary">
					</strong>								
				</div>
				<div class="row">							  
					<div class="form-group" style="margin-right: 132px;">
						...
						<div class="input-group col-xs-12 uploadDiv">
						  ...
						  <input type="text" ng-model="productTestModel.productTestBrowseFile" class="browseFileInput form-control input-lg" style="width: 80%;left: 209px !important;" disabled placeholder="Upload Product Categories">
					...
					<div>
					   <a class="right-nav downloadTestCsv" download href="{{url('public/sample/product_categories.csv')}}">Download Product Categories Sample</a>
					</div>			
				</div>
			</form>	
